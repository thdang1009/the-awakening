...
export const ALL_NODES: SkillNode[] = [
  ...
  },
  {
    ...
    label: 'BULLET STORM',
    description: 'A relentless torrent of energy bolts that fire in tight rapid bursts.',
    effects: [{ stat: 'fireRateBonus', value: 0.22 }],
    behaviors: ['RAPID_BURST'],
  ...
  },
  {
    ...
    description: 'Overcharge the emitter. Fire rate ×2.8, damage ×0.7. Bursts become continuous salvos.',
    effects: [
      { stat: 'fireRateMultiplier', value: 2.8 },
      { stat: 'damageMultiplier',   value: 0.7 },
    ],
    behaviors: ['RAPID_BURST'],
    connections: [],
  },
  ...
  },
  {
    ...
    label: 'HEAVY CALIBER',
    description: 'Raw, crushing projectile power. Impact force knocks enemies back.',
  ...
  },
  {
    ...
    description: 'Collapses each shot into a micro-singularity. Damage ×2.0, fire rate ×0.6. Projectiles detonate on impact.',
    effects: [
      { stat: 'damageMultiplier',   value: 2.0 },
      { stat: 'fireRateMultiplier', value: 0.6 },
    ],
    behaviors: ['EXPLOSIVE'],
    connections: [],
  },
  ...
  },
  {
    ...
    description: 'The Nexus becomes a near-impenetrable fortress. Enemies that strike it are scorched by reflected energy.',
  ...
  },
  {
    ...
    description: 'Max HP ×2.0. All incoming damage reduced by 25%. Thorns intensify — reflected damage doubled.',
    effects: [
  ...
  },
  {
    ...
    label: 'WARP SHOTS',
    description: 'Projectiles bend spacetime as they fly, curving toward enemies mid-flight.',
  ...
  },
  {
    ...
    description: 'Projectiles phase through enemies, hitting all in their path. Homing instinct becomes perfect lock-on.',
    effects: [],
    behaviors: ['INFINITE_PIERCE', 'HOMING'],
    connections: [],
  },
  ...
  },
  {
    ...
    label: 'VOLLEY',
    description: 'A true volley: three simultaneous projectiles. Each bolt arcs to a second target after its first kill.',
  ...
  },
  {
    ...
    label: 'NOVA BURST',
    description: 'Abandons targeting entirely. Fires 8 projectiles in all directions simultaneously. Every bolt chains.',
    effects: [],
    behaviors: ['NOVA_BURST', 'CHAIN_1'],
    connections: [],
  },
  ...
  },
  {
    ...
    description: 'Kills generate experience. +1 skill point per wave clear. Weakened enemies are automatically executed.',
    effects: [{ stat: 'scoreBonus', value: 0.40 }, { stat: 'bonusSPPerWave', value: 1 }],
    behaviors: ['CULL_THRESHOLD'],
  ...
  },
  {
    ...
    label: 'OMNISCIENT',
    description: 'All-seeing. Score per kill ×2.0. Every enemy is an archive — none escape below 20% HP.',
